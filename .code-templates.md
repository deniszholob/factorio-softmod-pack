...
GUI Template
Replace `__MODULE_NAME__` with your module name
...
Corresponding locale cfg template
```cfg
[__MODULE_NAME__]
# menu_btn_caption=__MODULE_NAME__
menu_btn_tooltip=Toggle __MODULE_NAME__ on or off
master_frame_caption=__MODULE_NAME__ Title
