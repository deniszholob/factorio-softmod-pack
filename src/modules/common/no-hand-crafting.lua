...
-- ======================================================= --
NoHandCrafting = {
    NO_HAND_CRAFT_PERMISSION_GROUP = 'no_hand_craft',
    NO_HAND_CRAFT_DEFAULT_SETTINGS = {
...
function NoHandCrafting.on_player_created(event)
    local player = game.players[event.player_index]
    NoHandCrafting.addNoHandcraftKitItems(player)
    NoHandCrafting.disallowHandcrafting(player)
...
-- ================== --
Event.register(
    defines.events.on_player_created, NoHandCrafting.on_player_created
)
...
function NoHandCrafting.addNoHandcraftKitItems(player)
    ...
    if NoHandCrafting.NO_HAND_CRAFT_DEFAULT_SETTINGS.useSteamInsteadOfSolar then
    ...
    -- Accumulators
    if NoHandCrafting.NO_HAND_CRAFT_DEFAULT_SETTINGS.addAccumulator then
...
--- @param player LuaPlayer
function NoHandCrafting.disallowHandcrafting(player)
    -- Get existing grouip or add one if doesnt exist
    local group =
        game.permissions.get_group(NoHandCrafting.NO_HAND_CRAFT_PERMISSION_GROUP) or
        game.permissions.create_group(NoHandCrafting.NO_HAND_CRAFT_PERMISSION_GROUP)
    ...
    game.permissions.get_group(NoHandCrafting.NO_HAND_CRAFT_PERMISSION_GROUP)
        .add_player(player)
end
